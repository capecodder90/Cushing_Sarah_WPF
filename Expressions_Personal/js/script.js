...
var carName1 = prompt("What is the name of your first car?"); // asks the user to input the name of the first car.
var carName2 = prompt("What is the name of your second car?"); // asks the user to input the name of the second car.
var carName3 = prompt("What is the name of your third car?"); // asks the user to input the name of the third car.
var tankSize = prompt("What is the size (in gallons) of your gas tank?"); // asks the user to input the size in gallons of each gas tank
