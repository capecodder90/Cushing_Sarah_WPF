...
if(accountBalance == false && accountBalance != balanceToStart){
    console.log("Sorry, but that is not a valid number."); // ...print the Sorry invalid input message to the console
// otherwise, if the account balance is greater than or equal to the balance required to start...
    ...
    if(recentPmts == false && recentPmts != balanceToStart){
        console.log("Please enter a valid number."); // ...print the Sorry invalid input message to the console
    // otherwise...
    }else{
        ...
        // otherwise...
            ...
            console.log("Sorry, but your account still has a balance of $" + accountTotal + ". Please remit payment at your earliest convenience, and we will begin your project upon receipt."); // ... print the "sorry your account still has a balance" message to the console
        }
    }
}